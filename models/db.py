...
auth.settings.extra_fields['auth_user'] = [
    ...
    # Lista dos subscrições do utilizador
    Field('subscricao', 'list:reference categoria', label='Subscrições:', requires = IS_IN_DB(db, 'categoria.id', '%(titulo)s', multiple=True)),
